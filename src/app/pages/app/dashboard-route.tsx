  ...
  return (
    <Container>
      ...
      <Row gutter={[16, 16]}>
        {/* Left column */}
        <Col xs={24} lg={12}>
          <Card title='Vehicle Fleet Overview' bordered={false} className='rounded-2xl shadow-sm'>
            <Row gutter={[16, 16]}>
              ...
              <Col xs={12} sm={12} lg={12}>
                <StatsCard title='Maintenance' value={stats?.maintenanceVehicles || 0} icon={Wrench} color='#faad14' />
              </Col>
              <Col xs={12} sm={12} lg={12}>
        ...
        {/* Right column */}
        <Col xs={24} lg={12}>
          <Card title='Trip Performance' bordered={false} className='rounded-2xl shadow-sm'>
            <Row gutter={[16, 16]}>
              <Col xs={12}>
      ...
      {/* Booking Stats */}
      <Card title='Booking Insights' bordered={false} className='rounded-2xl shadow-sm mb-8'>
        <Row gutter={[16, 16]}>
...
//feat(booking): enhance booking management with ticket handling and detail retrieval --- IGNORE ---
